<template>
	<div id="app">
		<div class="top-0 w-100 z-1 flex-none flex flex-row items-center pv3 ph4 bg-blue white">
			<div class="flex-none">
		...
		<div class="content" ref="dragWrap">
			<drag-move @mouseUp="mouseUp" :options="options" style="user-select: none;">
				<!-- <div slot="dragHack">拖拽区域</div> -->
				<div style="height:100px;width:100px;background:yellow;cursor: default;user-select: none;">主体内容</div>
			</drag-move>
		</div>
	</div>
</template>
